    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sessao.getAttribute("militarAutenticado") != null){
            try{
                ...
                response.sendRedirect("/sgdis/restrito/montarGradeCurricular.jsp?nav=disc&idCurso="+idCurso+"&codGrade="+codigoGrade+"&ed=2");
                throw new ServletException(ex);
            }
            //e=1: cadastro sucesso
            response.sendRedirect("/sgdis/restrito/montarGradeCurricular.jsp?nav=disc&idCurso="+idCurso+"&codGrade="+codigoGrade+"&ed=1");
