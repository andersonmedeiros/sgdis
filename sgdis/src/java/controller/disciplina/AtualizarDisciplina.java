...
public class AtualizarDisciplina extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AtualizarDisciplina</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AtualizarDisciplina at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sessao.getAttribute("militarAutenticado") != null){
            try{
                ...
                int ch = Integer.parseInt(request.getParameter("txtCHAtt").toUpperCase());
                ...
                response.sendRedirect("/sgdis/restrito/disciplina.jsp?e=5");
                throw new ServletException(ex);
            }
            //e=6: atualização sucesso
            response.sendRedirect("/sgdis/restrito/disciplina.jsp?e=6");
