            ...
            <div class="accordion" id="accordionCursos">
                <div class="card">
                    <%
                        ...
                        int qtdeCursos = cursos.size();
                        
                        for(int i=0; i<qtdeCursos; i++){
                            out.println("<div class=\"card-header\" id=heading" + cursos.get(i).getId() + ">");
                            out.println("   <h5 class=\"mb-0\">");
                            out.println("       <button class=\"btn btn-link\" type=\"button\" data-toggle=\"collapse\" data-target=#collapse" + cursos.get(i).getId() +  "aria-expanded=\"true\" aria-controls=collapse" + cursos.get(i).getId()+ ">");
                            out.println("" +    cursos.get(i).getNome()  + "");
                            out.println("       </button>");
                            out.println("   </h5>");
                            out.println("</div>");
                        }
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionCursos">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionCursos">
                        <div class="card-body">
                            <div class="row" style="margin-left: 0">
                                <div class="list-group col">
                                    <button type="button" class="list-group-item list-group-item-action active">
