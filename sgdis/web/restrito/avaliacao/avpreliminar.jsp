                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="txtAvaliacao" name="txtAvaliacao">
                                    ...
                                    <%
                                        for(GrupoAcesso ga : grpsacesso){
                                            if(ga.getId() == 2){
                                                out.println("<option value=\"3\">TESTE DE CONHECIMENTO MILITAR</option>");
                                            }
                                            else if(ga.getId() == 3){
                                                out.println("<option value=\"4\">EXAME DE APTIDÃO FÍSICA</option>");
                                            }
                                            else if(ga.getId() == 4){
                                                out.println("<option value=\"1\">AVALIAÇÃO PSICOLÓGICA</option>");
                                            }
                                            else if(ga.getId() == 5){
                                                out.println("<option value=\"2\">INSPEÇÃO DE SAÚDE</option>");
                                            }
                                        }
                                    %>                                                              
                                </select>
